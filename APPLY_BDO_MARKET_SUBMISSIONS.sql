-- Apply this migration directly in Supabase SQL Editor
...
-- Create indexes
CREATE INDEX IF NOT EXISTS idx_bdo_submissions_bdo_user_id ON public.bdo_market_submissions(bdo_user_id);
CREATE INDEX IF NOT EXISTS idx_bdo_submissions_submission_date ON public.bdo_market_submissions(submission_date DESC);
CREATE INDEX IF NOT EXISTS idx_bdo_submissions_status ON public.bdo_market_submissions(status);
CREATE INDEX IF NOT EXISTS idx_bdo_submissions_market_id ON public.bdo_market_submissions(market_id);
...
DROP POLICY IF EXISTS "BDOs can create submissions" ON public.bdo_market_submissions;
DROP POLICY IF EXISTS "BDOs can update their own pending submissions" ON public.bdo_market_submissions;
DROP POLICY IF EXISTS "Admins can manage all submissions" ON public.bdo_market_submissions;
...
DROP TRIGGER IF EXISTS update_bdo_market_submissions_updated_at ON public.bdo_market_submissions;
